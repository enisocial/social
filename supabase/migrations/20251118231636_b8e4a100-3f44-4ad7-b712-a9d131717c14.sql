-- Drop and recreate functions with fixed ambiguous column references
...
-- Recreate get_personalized_feed with proper table aliases
...
-- Recreate get_friend_suggestions with proper table aliases
